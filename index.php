...
if (
    ...
    in_array($_SESSION['user_role'], ['admin', 'super_admin', 'user', 'editor'])
) {
  ...
  <div class="container py-5">
    <div class="row mb-4 align-items-center flex-lg-row-reverse">
      ...
      <div class="col-md-6 col-xl-5 text-center text-md-start">
        ...
        <a class="btn btn-lg btn-primary" style="background-color: black;" href="shop.php" role="button">Shop Now</a>
      </div>
    </div>
  </div>
</div>
