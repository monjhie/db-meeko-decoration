...
<div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="addCategoryForm" action="../process/editor-add-category-process.php" method="POST">
  ...
  $(function() {
    ...
    $('#categoryList').on('click', '.delete-category', function() {
      ...
      if (confirm("Are you sure you want to delete this category?")) {
        window.location.href = '../process/editor-delete-category-process.php?id=' + categoryId;
      }
    });
  });
</script>
