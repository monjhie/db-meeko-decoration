...
<div class="container mt-4">
    ...
    <div class="button-group">
        <a href="admin-add-product.php" class="btn btn-custom">+ Add Product</a>
        <a href="admin-add-category.php" class="btn btn-custom">+ Add Category</a>
                ...
                <?php if (!empty($items)): ?>
                    <?php foreach ($items as $item): ?>
                        <tr>
                            ...
                            <td>
                                <a href="admin-edit-product.php?product_id=<?= $item['product_id'] ?>" class="btn btn-warning btn-sm mb-1">Edit</a>
                                <a href="../process/admin-delete-product-process.php?product_id=<?= $item['product_id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
