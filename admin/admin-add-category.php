...
<div class="container my-5">
  <div class="row mb-4">
    <div class="col-12">
      <a href="admin-products.php" class="btn btn-back">
...
<div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="addCategoryForm" action="../process/admin-add-category-process.php" method="POST">
  ...
  $(function() {
    ...
    $('#categoryList').on('click', '.delete-category', function() {
      ...
      if (confirm("Are you sure you want to delete this category?")) {
        window.location.href = '../process/admin-delete-category-process.php?id=' + categoryId;
      }
    });
  });
</script>
