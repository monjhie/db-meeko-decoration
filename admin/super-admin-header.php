...
if (!isset($_SESSION['id']) || $_SESSION['user_role'] !== 'super_admin') {
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="super-admin-home.php">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="super-admin-role.php">Manage Admin</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="super-admin-products.php">Manage Products</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="super-admin-settings.php">Settings</a>
                        </li>
                    </ul>
