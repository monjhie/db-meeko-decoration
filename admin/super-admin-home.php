    ...
    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
      <div class="card text-center shadow-sm border-0 bg-dark text-white custom-card">
        <div class="card-body d-flex flex-column">
          ...
          <h5 class="card-title mt-3">Manage Admin</h5>
          <p class="card-text mt-2">Manage admin users, assign roles, and ensure proper access control within the system.</p>
          <a href="super-admin-role.php" class="btn btn-outline-light w-100 mt-auto">View</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
      <div class="card text-center shadow-sm border-0 bg-dark text-white custom-card">
        <div class="card-body d-flex flex-column">
          ...
          <h5 class="card-title mt-3">Manage Product</h5>
          ...
          <a href="super-admin-products.php" class="btn btn-outline-light w-100 mt-auto">View</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
      <div class="card text-center shadow-sm border-0 bg-dark text-white custom-card">
        <div class="card-body d-flex flex-column">
          ...
          <p class="card-text mt-2">Modify website settings like title, logo, contact info, banners, and text sections easily.</p>
          <a href="super-admin-settings.php" class="btn btn-outline-light w-100 mt-auto">View</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
      <div class="card text-center shadow-sm border-0 bg-dark text-white custom-card">
        <div class="card-body d-flex flex-column">
          ...
          <a href="super-admin-add-category.php" class="btn btn-outline-light w-100 mt-auto">Add Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
      <div class="card text-center shadow-sm border-0 bg-dark text-white custom-card">
        <div class="card-body d-flex flex-column">
          ...
          <a href="super-admin-add-product.php" class="btn btn-outline-light w-100 mt-auto">Add Now</a>
        </div>
      </div>
    </div>
